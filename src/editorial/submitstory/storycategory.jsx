...
export default function StoriesCategories(){
    return <main className=" h-[100%] mt-10 w-[100%]">
        ...
        <div className="flex w-[90%] h-full justify-self-center md:w-[16%]">
        <StoriesCategoriesCard category={"Work & Life"} description={"Balancing your career and personal life?  Talk about balancing career and personal life or overcoming challenges at work"} className={"h-[6em] md:h-[11em]"} className2={"w-[80%] md:w-[62%]"} className3={'py-0 md:py-3.5'}/>
        </div>
