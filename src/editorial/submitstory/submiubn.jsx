...
export default function SubmitUbn(){
    return <main className="mt-10">
        ...
        <section className="flex flex-col w-[80%] justify-center h-full gap-10 mt-10 md:flex-row md:gap-20 md:items-center lg:items-start">
        ...
        <section className="flex flex-col w-[80%] justify-center h-full gap-10 mt-10 md:flex-row md:flex-row-reverse md:gap-20 md:items-center lg:items-start">
