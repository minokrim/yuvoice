...
export default function LandingPage1(){
    return <main className="h-[100vh] w-full bg-cover bg-center bg-no-repeat flex flex-col items-center justify-center md:items-start" style={{ backgroundImage: `url(${l1})` }}>
        ...
        <section>
            ...
            <p>To create a <b>global online town square for superheroes</b> — a space where <b>success is measured by the good you do</b> , not by fame, wealth, or power.</p>
        </section>
        ...
        <section>
            ...
            <p>In our world, <b>people are valued for their purposeand positive contributions </b>,and <b>communities are built around shared causes </b>, not superficial connections.</p>
        </section>
