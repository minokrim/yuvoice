...
export default function LandingPage2(){
    return <main className="h-[100vh] w-full bg-cover bg-center bg-no-repeat flex flex-col" style={{ backgroundImage: `url(${l2})` }}>
        <section className="mt-28 py-0 pl-5 w-[90%] flex flex-col md:w-[60%] lg:w-[30%] z-50 relative text-left md:pl-32 lg:py-10 lg:mt-40 justify-self-start ">
            ...
            <button className="text-white bg-blue-700 font-light border-none rounded-md py-2 px-5 text-base mt-5 md:mt-10 lg:mt-20">Read More</button>
        </section>
    </main>
}