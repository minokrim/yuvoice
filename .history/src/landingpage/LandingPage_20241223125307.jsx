...
import background2 from "../assets/anotherimage.jpg";
      ...
      <header className="header">
        ...
        {currentSlide === 1 && (
          <div className="header-content">
            <h2>Discover More</h2>
            <p>
              Explore the opportunities and stories that <b>shape the world</b>. <br />
              Join our platform to <b>connect, inspire, and make a difference.</b>
            </p>
