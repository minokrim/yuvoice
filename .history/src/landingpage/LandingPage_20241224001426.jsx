      ...
      <header className="header">
        ...
        {currentSlide === 1 && (
          <div className="header-content">
            <h2>Reclamation</h2>
            <p>
             Emile scowled theatrically at the mirrir. His imagination ran wild with unearned pride. That's how<br/>I'll look, he thought. That's how I'll look when i march <br/> up to recieve that shiny, new badge. He could see it <br/> in his mind so clearly.
            </p>
