...
const LandingPage = () => {
  return (
    <div className="landing-page">
      ...
      <header className="header">
        ...
        >
          ...
          <div>
            <img src="/path/to/another-image.jpg" alt="Background2" />
          </div>
        </Carousel>
    ...
    To create a <b>global online town square for superheroes </b><br />
...
<h2>Our Belief</h2>
<p>
  In our world, <b>People are valued for their purpose and<br/>positive contributions , and communities are built <br/> around shared causes,</b>not superficial connections.
